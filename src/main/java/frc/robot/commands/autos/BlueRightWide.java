...
public class BlueRightWide extends SequentialCommandGroup {
    ...
    public BlueRightWide(
        ...
        Pose2d pickUpPosition = new Pose2d(8.5, 3.765, Rotation2d.fromDegrees(90));
                ...
                Commands.parallel( //middle of field, pick up path 
                        new PIDToPositionSpline( //spiral setup
                                ...
                                new ArrayList<Pose2d>(List.of(
                                        new Pose2d(8.3, 1.146, Rotation2d.fromDegrees(90)),
                                        pickUpPosition)),
                ...
                // second cycle
                 Commands.parallel(
                        new PIDToPositionSpline(
                                ...
                                new ArrayList<Pose2d>(List.of(
                                        new Pose2d(7.5, 0.583,Rotation2d.fromDegrees(90)))),
                                new ArrayList<Double>(List.of( .3)),
