...
public class RedLeftTrenchDeep extends SequentialCommandGroup {
    ...
    public RedLeftTrenchDeep(
        ...
        Pose2d pickUpPosition = new Pose2d(8.887, 4.165, Rotation2d.fromDegrees(90));
