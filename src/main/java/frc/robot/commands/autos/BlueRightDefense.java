...
public class BlueRightDefense extends SequentialCommandGroup {
    ...
    public BlueRightDefense(
        ...
        Pose2d startPosition = new Pose2d(3.547, 0.474, Rotation2d.fromDegrees(90));
        Pose2d defensePosition = new Pose2d(8.153, 4.203, Rotation2d.fromDegrees(180)); //4.303
                ...
                Commands.parallel( 
                        new PIDToPositionSpline(
                                ...
                                new ArrayList<Pose2d>(List.of(
                                        new Pose2d(7.809, 1.348, Rotation2d.fromDegrees(90)),
                                        new Pose2d(7.609, 1.55, Rotation2d.fromDegrees(90)),
                                        new Pose2d(7.653, 3.767, Rotation2d.fromDegrees(90)),
                                        defensePosition)),
