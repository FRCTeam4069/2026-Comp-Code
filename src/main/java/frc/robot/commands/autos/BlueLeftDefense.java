...
public class BlueLeftDefense extends SequentialCommandGroup {
    ...
    public BlueLeftDefense(
        ...
        Pose2d startPosition = new Pose2d(3.547, 7.596, Rotation2d.fromDegrees(-90));
                ...
                Commands.parallel( 
                        new PIDToPositionSpline(
                                ...
                                new ArrayList<Pose2d>(List.of(
                                        ...
                                        new Pose2d(7.653, 4.303, Rotation2d.fromDegrees(-90)),
                                        defensePosition)),
