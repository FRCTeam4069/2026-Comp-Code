...
public class BlueLeftTrenchDeep extends SequentialCommandGroup {
    ...
    public BlueLeftTrenchDeep(
        ...
        Pose2d pickUpPosition = new Pose2d(7.653, 3.803, Rotation2d.fromDegrees(-90)); //4.303
