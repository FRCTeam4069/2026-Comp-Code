...
public class RedLeftDefense extends SequentialCommandGroup {
    ...
    public RedLeftDefense(
        ...
        Pose2d startPosition = new Pose2d(12.953, 7.596, Rotation2d.fromDegrees(-90));
                ...
                Commands.parallel( 
                        new PIDToPositionSpline(
                                ...
                                new ArrayList<Pose2d>(List.of(
                                        new Pose2d(8.731, 6.722, Rotation2d.fromDegrees(-90)),
                                        new Pose2d(8.931, 6.52, Rotation2d.fromDegrees(-90)),
                                        new Pose2d(8.887, 4.303, Rotation2d.fromDegrees(-90)),
                                        defensePosition)),
